...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //
        Noticia noticia1 =
                new Noticia("Hoy es diseño","Va a haber un cambio en el logo de hoy es diseño","30/08/2018");


        Noticia noticia2 =
                new Noticia("Titulo","Va a haber un cambio en el logo de hoy es diseño","31/08/2018");
